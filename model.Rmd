...
US_model_cleaned_0.5 <- lm(data = US_lm_cleaned_0.5, SHARE.RE.IN.ELECTRICITY ~ .)
...
US_model_cleaned_0.75 <- lm(data = US_lm_cleaned_0.75, SHARE.RE.IN.ELECTRICITY ~ .)
...
#Residual st. error increased from 0.5 model to 0.1513 although the variables were more correlated to the target variable

#Predicting target variable using train and test data
pred_train_0.5 <- predict(US_model_cleaned_0.5, newdata = train_0.5)
pred_test_0.5 <- predict(US_model_cleaned_0.5, newdata = test_0.5)

pred_train_0.75 <- predict(US_model_cleaned_0.75, newdata = train_0.75)
pred_train_0.75 <- predict(US_model_cleaned_0.75, newdata = test_0.75)
```
